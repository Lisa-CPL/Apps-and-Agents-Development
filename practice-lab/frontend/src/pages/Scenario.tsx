    ...
    <div className="min-h-screen bg-transparent flex flex-col">
      ...
      >
         ...
         <div className="space-y-4">
            <motion.h3 variants={itemVariants} className="text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">Your Objective</motion.h3>
            <motion.div variants={itemVariants} className="bg-white/50 border border-cpl-border rounded-2xl p-5 flex items-start gap-4">
